...
c = Cube("WWWWWWWWWOOOOOOOOOGGGGGGGGGRRRRRRRRRBBBBBBBBBYYYYYYYYY")
c.turn("L F F L L D D F U U B B R R F' L L U U B' U U R' U U F F R B F' L'")
c.print_cube()